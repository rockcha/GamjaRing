...
export const PRODUCERS: Producer[] = [
  ...
  },
  {
    id: "pig-pen",
    name: "돼지우리",
    price: 210, // 2종이지만 시간이 더 길어 닭장보다 조금 더 저렴
    produces: ["고기", "베이컨"],
