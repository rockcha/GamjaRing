...
export const FISHES: FishInfo[] = [
  ...
  },
  {
    ...
    ingredient: "양파",
    rarity: "희귀",
    description: "바위 틈에 숨어 예리한 이빨로 사냥하는 포식자예요.",
  },
  {
    id: "horseshoe-crab",
    labelKo: "투구게",
  ...
  },
  {
    ...
    ingredient: "베이컨",
    rarity: "희귀",
    description: "민첩한 몸놀림으로 물고기를 쫓는 영리한 포식자예요.",
  },
  {
    id: "saltwater-croc",
    labelKo: "바다악어",
  ...
  },
  {
    ...
    ingredient: "밀",
    rarity: "희귀",
    description: "뱀처럼 가늘고 긴 몸으로 모래와 바위를 누비는 포식자예요.",
  },
  {
    id: "orca",
    labelKo: "범고래",
